...
public class MainActivity extends AppCompatActivity {
    ...
    public void newMatch() {  //A game is composed of three matches
        ...
        if(correctButton==0) {
            ...
            button3.setText(correctans - 3 + "");
            button4.setText(correctans + 2 + "");
        }
        if(correctButton==1){
            button1.setText(correctans+5 + "");
            button2.setText(correctans + "");
            button3.setText(correctans-6 + "");
            button4.setText(correctans+7 + "");}

        if(correctButton==2){
            button1.setText(correctans-3 + "");
            button2.setText(correctans+7 + "");
            button3.setText(correctans + "");
            button4.setText(correctans-6 + "");}
        if(correctButton==3){
            button1.setText(correctans-5 + "");
            button2.setText(correctans-9 + "");
